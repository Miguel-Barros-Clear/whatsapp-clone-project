...
export class WhatsAppController {
        ...
        this._firebase.initAuth().then((res) => {
            ...
            this._user.on('datachange', (data) => {
                ...
                if (data.photo) {
                    ...
                    let newPhoto = this.el.myPhoto.querySelector('img');

                    newPhoto.src = data.photo;
                    newPhoto.show();
                }
    ...
    initEvents() {
        ...
        this.el.inputSearchContacts.on('keyup', (e) => {
            ...
            console.log(this._user.getContacts(this.el.inputSearchContacts.value));
        });
            ...
            if (this.el.inputDocument.files.length) {
                ...
                this._documentPreviewController.getPreviewData().then((result) => {
                    ...
                    switch (file.type) {
                        ...
                        case 'application/vnd.openxmlformats-offiecedocument.presentationml.presentation':
        ...
        this.el.btnEmojis.on('click', (e) => {
            ...
            (this.el.panelEmojis.hasClass('open')) ? this.el.panelEmojis.removeClass('open') : this.el.panelEmojis.addClass('open');
        })
